...
import edu.utad.movielibrary.databinding.FragmentPopularSeriesBinding
...
class PopularSeriesFragment : Fragment() {
    ...
    private fun initRecyclerView() {
        ...
        val recyclerView = binding.popularSeriesRecycler
    ...
    private fun callApi() {
        ...
        object : JsonObjectRequest(
            Method.GET, "$BASE_URL/tv/popular", null,
            Response.Listener { response ->
                ...
                binding.popularSeriesRecycler.adapter?.notifyDataSetChanged()
    ...
    private fun onItemClicked(movie: MovieModel) {
        ...
        findNavController().navigate(
            R.id.action_popularSeriesFragment_to_movieDetailsFragment,
            bundle
        )
